...
const RefundPolicy: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <Section>
        <Paragraph>
          At {COMPANY_INFO.name}, we stand behind the quality of our C++ programming courses and want you to be satisfied with your learning experience. 
          This refund policy outlines the terms and conditions for refunds on our digital C++ programming course purchases.
        </Paragraph>
      </Section>
      ...
      <Section>
        ...
        <Paragraph>
          We offer a 7-day satisfaction guarantee on all C++ programming course purchases. You may request a refund within 7 days 
      ...
      <Section>
        ...
        <Paragraph>
          To request a refund for your C++ programming course purchase:
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          You will see "C++ PROGRAMMING COURSES" or "CPROGLY.COM" as the refund descriptor on your statement.
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          • Request a course credit for a different C++ programming course that better suits your needs<br/>
