...
const Blog: React.FC = () => {
  ...
  const blogPosts: BlogPostData[] = [
    ...
    {
      id: 10,
      title: "� Coming Soon: Advanced Memory Management & Performance Optimization",
  ...
  const popularPosts = [
    ...
    { id: 4, title: "� Advanced Memory Management", readTime: "Coming Soon", comingSoon: true }
  ];
