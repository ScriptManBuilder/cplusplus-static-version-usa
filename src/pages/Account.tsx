...
const Account: React.FC = () => {
  ...
  const renderCoursesSection = () => {
    ...
    if (!isTestAccount) {
      return (
        <div>
          <SectionTitle>MY C++ COURSES</SectionTitle>
          
          <InfoCard>
            <EmptyOrdersText>
              Your purchased C++ programming courses will appear here after successful payment.
            </EmptyOrdersText>
            <EmptyOrdersText style={{ fontSize: '1rem', marginTop: '1rem', opacity: 0.8 }}>
              Once you purchase any C++ programming course, you'll have lifetime access to all course materials, 
              including videos, downloadable resources, and future updates.
            </EmptyOrdersText>
            <EmptyOrdersButtonWrapper>
              <ShoppingButton as={Link} to="/products" variant="primary">
                Browse C++ Programming Courses
              </ShoppingButton>
            </EmptyOrdersButtonWrapper>
          </InfoCard>
        </div>
    ...
    return (
      <div>
        <SectionTitle>MY C++ PROGRAMMING COURSES</SectionTitle>
        ...
        <div style={{ 
          ...
          }}>Continue your C++ programming mastery journey</p>
          <div style={{ 
            display: 'flex', 
