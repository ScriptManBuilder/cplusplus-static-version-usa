...
const About: React.FC = () => {
  ...
  return (
    <AboutWrapper>
        ...
        <Container>
          <ContentContainer>
            <CompanyName ref={setElementRef(0)}>
              {splitTextToLetters('C++ COURSES')}
            </CompanyName>
            
            <MissionText ref={setElementRef(1)}>
              {splitTextToWords('To empower developers worldwide with professional C++ programming education,')}
            </MissionText>
            
            <MissionText ref={setElementRef(2)}>
              {splitTextToWords('providing comprehensive courses that transform programming concepts into practical C++ development skills.')}
            </MissionText>
            
            <DescriptionText ref={setElementRef(3)} className="description-text">
              {splitTextToChars('Our expertly crafted C++ programming courses cover object-oriented programming, data structures, algorithms, memory management, and performance optimization. Each course is designed with hands-on projects, real-world applications, and professional techniques to help you master C++ development and advance your career in the software industry.')}
            </DescriptionText>
            
            <ProductsCallToAction ref={setElementRef(4)}>
              <ProductsCard to="/products">
                <ProductsCardTitle>Explore Our C++ Programming Courses</ProductsCardTitle>
                <ProductsCardDescription>
                  Discover comprehensive C++ programming learning programs designed for all skill levels
                </ProductsCardDescription>
                <ProductsCardButton>
                  View Courses
                </ProductsCardButton>
        ...
        <Container>
          <StatsContainer>
            <StatsTitle ref={setElementRef(20)}>
              {splitTextToWords('Transforming Careers Through C++ Programming Education')}
            </StatsTitle>
            ...
            <StatsGrid>
              <StatCard ref={setElementRef(21)}>
                ...
                <StatDescription>From C++ programming beginners to professional software developers across 100+ countries</StatDescription>
              </StatCard>
              ...
              <StatCard ref={setElementRef(23)}>
                ...
                <StatDescription>Leading software companies hiring our C++ programming professionals</StatDescription>
              </StatCard>
              ...
              <StatCard ref={setElementRef(25)}>
                ...
                <StatLabel>C++ Programming Specializations</StatLabel>
                <StatDescription>From system programming to game development and embedded systems</StatDescription>
              </StatCard>
              ...
              <StatCard ref={setElementRef(26)}>
                ...
                <StatDescription>Consistently rated as the top C++ programming learning platform</StatDescription>
              </StatCard>
            </StatsGrid>
          </StatsContainer>
        </Container>
      ...
      {/* C++ Programming Learning Timeline Section */}
      {/* <TimelineSection>
        <Container>
          <TimelineContainer>
            <SectionTitle ref={setElementRef(12)} style={{ color: '#2d3748' }}>
              {splitTextToLetters('OUR C++ PROGRAMMING JOURNEY')}
            </SectionTitle>
            ...
            <Timeline>
              <TimelineItem ref={setElementRef(13)}>
                ...
                <TimelineContent>
                  ...
                  <TimelineDescription>
                    CplusplusCourses was founded with a vision to democratize C++ programming education 
                    and make C++ development accessible to everyone, from complete beginners to advanced software developers.
                  </TimelineDescription>
                </TimelineContent>
              </TimelineItem>
      ...
      {/* C++ Programming Education Team Section */}
      <LeadershipSection>
        <Container>
          <LeadershipContainer>
            ...
            <LeadershipGrid>
              <ClickableLeaderCard ref={setElementRef(6)} onClick={openModal}>
                ...
                <LeaderInfo>
                  ...
                  <LeaderTitle>C++ Programming Experts & Educators</LeaderTitle>
                  <LeaderDescription>
                    Passionate about C++ programming and dedicated to making C++ programming education accessible to everyone. 
                    Creates comprehensive video courses to help others learn and master the art of C++ programming.
                  </LeaderDescription>
                </LeaderInfo>
              </ClickableLeaderCard>
            </LeadershipGrid>
          ...
          <ValuesContainer>
            ...
            <ValuesGrid>
              <ValueCard ref={setElementRef(28)}>
                <ValueIcon>🎯</ValueIcon>
                <ValueTitle>Excellence in C++ Programming Education</ValueTitle>
                <ValueDescription>
                  We maintain the highest standards in C++ programming education, constantly updating 
                  our curriculum with the latest C++ standards and industry best practices.
                </ValueDescription>
              </ValueCard>
              ...
              <ValueCard ref={setElementRef(29)}>
                ...
                <ValueDescription>
                  C++ programming should be accessible to everyone. We create a supportive environment 
                  where programmers from all backgrounds can master programming fundamentals.
                </ValueDescription>
              </ValueCard>

              <ValueCard ref={setElementRef(30)}>
                <ValueIcon>⚡</ValueIcon>
                <ValueTitle>Modern C++ Programming Techniques</ValueTitle>
                <ValueDescription>
                  We stay current with the latest C++ standards and development tools, 
                  bringing modern programming practices directly to our students.
                </ValueDescription>
              </ValueCard>
              ...
              <ValueCard ref={setElementRef(32)}>
                ...
                <ValueDescription>
                  C++ programming is an evolving field. We foster continuous learning 
              ...
              <ValueCard ref={setElementRef(33)}>
                ...
                <ValueDescription>
                  We focus on practical C++ programming skills that you can apply immediately 
                  in real projects, from desktop applications to game development and system programming.
                </ValueDescription>
              </ValueCard>
            </ValuesGrid>
            ...
            <MissionStatement ref={setElementRef(34)}>
              ...
              <MissionStatementText>
                To empower the next generation of software developers with world-class education, 
                practical skills, and real-world projects that drive programming career success. 
                We believe that by making C++ programming education accessible and excellent, we can help 
                students create powerful software applications while creating opportunities for everyone 
      ...
      <ModalOverlay isOpen={isModalOpen} onClick={closeModal}>
        <ModalContent isOpen={isModalOpen} onClick={(e) => e.stopPropagation()}>
          ...
          <ModalHeader>
            ...
            <ModalSubtitle>C++ Programming Education Experts</ModalSubtitle>
          </ModalHeader>

          <ModalDescription>
            Our team of professional C++ programming experts is dedicated to 
            transforming software development careers through comprehensive C++ programming education.
            <br /><br />
            We believe C++ programming should be accessible to everyone, from complete beginners to advanced developers looking to 
            refine their skills. That's why we created comprehensive video courses that break down complex C++ programming concepts 
            into understandable, practical lessons.
            <br /><br />
            Our mission is simple: to help others discover the amazing world of C++ programming and empower them 
            with the knowledge and skills needed to create powerful software applications and advance their development careers. Every course we create is designed with 
            real-world applications in mind, ensuring you can apply what you learn immediately.
            <br /><br />
            Whether you're just starting your C++ programming journey or looking to master advanced C++ programming techniques, 
            our expert team is here to guide you every step of the way. Let's explore the incredible possibilities of C++ programming together!
          </ModalDescription>
        </ModalContent>
      </ModalOverlay>
    </AboutWrapper>
