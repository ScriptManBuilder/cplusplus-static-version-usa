...
const ShippingPolicy: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <Section>
        <Paragraph>
          {COMPANY_INFO.name} delivers C++ programming courses digitally through our secure online learning platform. 
      ...
      <Section>
        ...
        <Paragraph>
          <strong>Our C++ programming courses are 100% digital products.</strong> There are no physical items to ship. All course materials, 
      ...
      <Section>
        ...
        <Paragraph>
          Upon successful payment, you will receive immediate access to your purchased C++ programming courses. No waiting, no shipping delays - 
      ...
      <Section>
        ...
        <Paragraph>
          Our digital C++ programming courses are available worldwide with internet access. There are no geographical restrictions 
