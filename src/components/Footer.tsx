  ...
  return (
    <FooterWrapper>
      <FooterContent>
        <FooterMain>
          <FooterSection>
            ...
            <ul>
              ...
              <li><Link to="/products">C++ Programming Courses</Link></li>
          ...
          <MoreAboutSection>
            ...
            <PromoCards>
              <PromoCard href="/products">
                <img src="/images/img_1.jpg" alt="C++ Programming Courses" />
                <PromoCardContent>
        ...
        <FooterBottom>
          <Copyright>
            Copyright  2025 {COMPANY_INFO.name}. All rights reserved. | Premium C++ Programming Education & Training Courses
          </Copyright>
        </FooterBottom>
      </FooterContent>
    </FooterWrapper>
